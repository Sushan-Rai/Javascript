...
**Weather App using openweathermap API**
    - Used the API to extract weather data using city and country
    - JSON response is converted to UI friendly format.
    - Error handling implemented in case of network failure or input invalid.