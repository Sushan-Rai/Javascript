...
**Infinite image data using picsum api**
- Detected onscroll event and performed paginated query to the api
- Used the fetch api to load data asynchronously
- while the data is fetched a loading element is used to indicate to the user the content is loading